...
-- Tiempo de generación: 27-08-2021 a las 19:37:42
...
--
-- Estructura de tabla para la tabla `activity_video`
--
...
--
-- Volcado de datos para la tabla `activity_video`
--
...
--
-- Estructura de tabla para la tabla `class_booking`
--
...
--
-- Volcado de datos para la tabla `class_booking`
--
...
(9, 'FFRREE', 4, 2, '', 12345554, '[\"Sunday\",\"Monday\",\"Tuesday\",\"Wednesday\",\"Thursday\",\"Friday\",\"Saturday\"]', '9:15', '10:15', 1, '2021-08-27');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `class_schedule_list`
--
...
--
-- Volcado de datos para la tabla `class_schedule_list`
--
...
(4, 9, '[\"Sunday\",\"Monday\",\"Tuesday\",\"Wednesday\",\"Thursday\",\"Friday\",\"Saturday\"]', '9:15', '10:15');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `general_setting`
--
...
--
-- Volcado de datos para la tabla `general_setting`
--
...
(1, 'Donde se cambia el Idioma a Español ??', '2021', 'admin@nacionalcode.com', '3504931577', 'co', 'admin@nacionalcode.com', 'Y-m-d', 'es', '1630038268_558886.png', '1630039416_212434.png', 'KG', 'Centimeter', 'Inches', 'Inches', 'Inches', 'Inches', 'Percentage', 0, 1, 1, 'sb-c4766m2274697@business.example.com', 'COP', 1, '5', 'Hello GYM_MEMBERNAME,\r\n      Your Membership  GYM_MEMBERSHIP  started at GYM_STARTDATE and it will expire on GYM_ENDDATE.\r\nThank You.', 1, 'jacinto del barrio', 'Copyright © 2021. All rights reserved. rrr', 1, 0, 'es', 'UTC', '13', 'es', '#66abf4', '#343232', 'sk_test_jS5bcjf5h9MujTWyKoD6DRnq00PbQHHbEZ', 'pk_test_c4hYx7QAugKith7bVGEy4kct00OvE0fDPx');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `gym_accessright`
--
...
--
-- Volcado de datos para la tabla `gym_accessright`
--
...
(3, 'GymGroup', '', 'group', 'group.png', 'Group', 1, 1, 1, '/gym-group/group-list'),
(4, 'GymMember', '', 'member', 'member.png', 'Member', 1, 1, 1, '/gym-member/member-list'),
(5, 'Activity', '', 'activity', 'activity.png', 'Activity', 1, 1, 1, '/activity/activity-list'),
(6, 'ClassSchedule', '', 'class-schedule', 'class-schedule.png', 'Class Schedule', 1, 1, 1, '/class-schedule/class-list'),
(7, 'ClassBooking', '', 'class-booking', 'class-schedule.png', 'Class Booking', 0, 1, 1, '/class-booking/booking-list'),
(8, 'GymAttendance', '', 'attendance', 'attendance.png', 'Attendance', 1, 1, 1, '/gym-attendance/attendance'),
(9, 'GymAssignWorkout', '', 'assign-workout', 'assigne-workout.png', 'Assigned Workouts', 1, 1, 1, '/gym-assign-workout/workout-log'),
(10, 'GymDailyWorkout', '', 'workouts', 'workout.png', 'Workouts', 1, 1, 1, '/gym-daily-workout/workout-list'),
(11, 'GymAccountant', '', 'accountant', 'accountant.png', 'Accountant', 1, 1, 1, '/gym-accountant/accountant-list'),
...
(15, 'GymProduct', '', 'product', 'products.png', 'Product', 0, 1, 1, '/gym-product/product-list'),
(16, 'GymStore', '', 'store', 'store.png', 'Store', 0, 1, 1, '/gym-store/sell-record'),
(17, 'GymNewsletter', '', 'news_letter', 'newsletter.png', 'Newsletter', 0, 0, 0, '/gym-newsletter/setting'),
(18, 'GymMessage', '', 'message', 'message.png', 'Message', 1, 1, 1, '/gym-message/compose-message'),
...
(22, 'GymReservation', '', 'reservation', 'reservation.png', 'Event', 1, 1, 1, '/gym-reservation/reservation-list'),
...
--
-- Estructura de tabla para la tabla `gym_assign_workout`
--
...
--
-- Volcado de datos para la tabla `gym_assign_workout`
--
...
--
-- Estructura de tabla para la tabla `gym_attendance`
--
...
--
-- Volcado de datos para la tabla `gym_attendance`
--
...
--
-- Estructura de tabla para la tabla `gym_daily_workout`
--
...
--
-- Volcado de datos para la tabla `gym_daily_workout`
--
...
--
-- Estructura de tabla para la tabla `gym_event_place`
--
...
--
-- Estructura de tabla para la tabla `gym_group`
--
...
--
-- Volcado de datos para la tabla `gym_group`
--

INSERT INTO `gym_group` (`id`, `name`, `image`, `created_by`, `created_date`) VALUES
(1, 'Spanish', '', NULL, '2021-08-27');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `gym_income_expense`
--
...
--
-- Estructura de tabla para la tabla `gym_interest_area`
--
...
--
-- Estructura de tabla para la tabla `gym_levels`
--
...
--
-- Volcado de datos para la tabla `gym_levels`
--
...
--
-- Estructura de tabla para la tabla `gym_measurement`
--
...
--
-- Estructura de tabla para la tabla `gym_member`
--
...
--
-- Volcado de datos para la tabla `gym_member`
--
...
(1, NULL, 'administrator', NULL, NULL, 'Nacional', '', 'Code', NULL, NULL, NULL, 'male', '2016-07-01', NULL, NULL, 'null', 'null', 't', '123123', '123123123', '', 'admin@nacionalcode.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin@nacionalcode.com', '$2y$10$.jwNZd3cwkNXPcN7k7KrbONT.Bk6vp8taawgCDeld1TCHSa6TPnV.', '1630038182_35397.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-06-04', NULL, 0, NULL),
...
(5, 1, 'member', 'M52721', NULL, 'pppp', '', 'pppp', 'Member', NULL, NULL, 'male', '2021-08-11', 1, '[\"1\"]', 'pppp', 'España', '', '9999', '095555555', '', 'pppp@pppp.es', '', '', '', '', '', '', '', 'pppp', '$2y$10$DogeI5XBAamT8/RyvLSyy.cT7gTyjDfI.Xq7/M4O02eOYvZsZFJry', 'Thumbnail-img.png', 2, NULL, NULL, NULL, '1970-01-01', '1970-01-01', '1', 'Continue', '2021-08-10', '2022-08-04', NULL, NULL, '2021-08-27', NULL, 0, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `gym_member_class`
--
...
--
-- Volcado de datos para la tabla `gym_member_class`
--
...
--
-- Estructura de tabla para la tabla `gym_message`
--
...
--
-- Estructura de tabla para la tabla `gym_newsletter`
--
...
--
-- Estructura de tabla para la tabla `gym_notice`
--
...
--
-- Estructura de tabla para la tabla `gym_nutrition`
--
...
--
-- Estructura de tabla para la tabla `gym_nutrition_data`
--
...
--
-- Estructura de tabla para la tabla `gym_product`
--
...
--
-- Estructura de tabla para la tabla `gym_reservation`
--
...
--
-- Estructura de tabla para la tabla `gym_roles`
--
...
--
-- Volcado de datos para la tabla `gym_roles`
--
...
--
-- Estructura de tabla para la tabla `gym_source`
--
...
--
-- Estructura de tabla para la tabla `gym_store`
--
...
--
-- Estructura de tabla para la tabla `gym_user_workout`
--
...
--
-- Volcado de datos para la tabla `gym_user_workout`
--
...
--
-- Estructura de tabla para la tabla `gym_workout_data`
--
...
--
-- Volcado de datos para la tabla `gym_workout_data`
--
...
--
-- Estructura de tabla para la tabla `installment_plan`
--
...
--
-- Volcado de datos para la tabla `installment_plan`
--
...
--
-- Estructura de tabla para la tabla `membership_activity`
--
...
--
-- Volcado de datos para la tabla `membership_activity`
--
...
--
-- Estructura de tabla para la tabla `membership_history`
--
...
--
-- Volcado de datos para la tabla `membership_history`
--
...
(2, 5, 1, 2, NULL, NULL, NULL, '1970-01-01', '1970-01-01', '2021-08-10', '2022-08-04', NULL, '2021-08-27');
...
(1, 3, 3, 200, 200, '2020-06-04', '2020-12-01', 'Continue', '0', '2020-06-04', 1),
(2, 5, 1, 500, 0, '2021-08-10', '2022-08-04', 'Continue', '0', '2021-08-27', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `membership_payment_history`
--
...
--
-- Volcado de datos para la tabla `membership_payment_history`
--
...
(2, 1, 150, 'Cash', '2021-08-27', 1, NULL);
...
--
-- Indices de la tabla `activity_video`
--
...
--
-- Indices de la tabla `class_booking`
--
...
--
-- Indices de la tabla `class_schedule_list`
--
ALTER TABLE `class_schedule_list`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `general_setting`
--
ALTER TABLE `general_setting`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_accessright`
--
ALTER TABLE `gym_accessright`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_assign_workout`
--
ALTER TABLE `gym_assign_workout`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_attendance`
--
ALTER TABLE `gym_attendance`
  ADD PRIMARY KEY (`attendance_id`);

--
-- Indices de la tabla `gym_daily_workout`
--
...
--
-- Indices de la tabla `gym_event_place`
--
ALTER TABLE `gym_event_place`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_group`
--
ALTER TABLE `gym_group`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_income_expense`
--
ALTER TABLE `gym_income_expense`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_interest_area`
--
ALTER TABLE `gym_interest_area`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_levels`
--
ALTER TABLE `gym_levels`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_measurement`
--
ALTER TABLE `gym_measurement`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_member`
--
ALTER TABLE `gym_member`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_member_class`
--
ALTER TABLE `gym_member_class`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_message`
--
ALTER TABLE `gym_message`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_newsletter`
--
ALTER TABLE `gym_newsletter`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_notice`
--
ALTER TABLE `gym_notice`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_nutrition`
--
ALTER TABLE `gym_nutrition`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_nutrition_data`
--
ALTER TABLE `gym_nutrition_data`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_product`
--
ALTER TABLE `gym_product`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_reservation`
--
ALTER TABLE `gym_reservation`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_roles`
--
ALTER TABLE `gym_roles`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_source`
--
ALTER TABLE `gym_source`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_store`
--
ALTER TABLE `gym_store`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_user_workout`
--
ALTER TABLE `gym_user_workout`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `gym_workout_data`
--
ALTER TABLE `gym_workout_data`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `installment_plan`
--
...
--
-- Indices de la tabla `membership_activity`
--
ALTER TABLE `membership_activity`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `membership_history`
--
...
--
-- Indices de la tabla `membership_payment_history`
--
...
--
-- AUTO_INCREMENT de la tabla `activity_video`
--
ALTER TABLE `activity_video`
...
--
-- AUTO_INCREMENT de la tabla `class_booking`
--
ALTER TABLE `class_booking`
...
--
-- AUTO_INCREMENT de la tabla `class_schedule_list`
--
ALTER TABLE `class_schedule_list`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `general_setting`
--
ALTER TABLE `general_setting`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `gym_accessright`
--
ALTER TABLE `gym_accessright`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de la tabla `gym_assign_workout`
--
ALTER TABLE `gym_assign_workout`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `gym_attendance`
--
ALTER TABLE `gym_attendance`
  MODIFY `attendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `gym_daily_workout`
--
ALTER TABLE `gym_daily_workout`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `gym_event_place`
--
ALTER TABLE `gym_event_place`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_group`
--
ALTER TABLE `gym_group`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `gym_income_expense`
--
ALTER TABLE `gym_income_expense`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_interest_area`
--
ALTER TABLE `gym_interest_area`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_levels`
--
ALTER TABLE `gym_levels`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `gym_measurement`
--
ALTER TABLE `gym_measurement`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_member`
--
ALTER TABLE `gym_member`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `gym_member_class`
--
ALTER TABLE `gym_member_class`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `gym_message`
--
ALTER TABLE `gym_message`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_newsletter`
--
ALTER TABLE `gym_newsletter`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_notice`
--
ALTER TABLE `gym_notice`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_nutrition`
--
ALTER TABLE `gym_nutrition`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_nutrition_data`
--
ALTER TABLE `gym_nutrition_data`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_product`
--
ALTER TABLE `gym_product`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_reservation`
--
ALTER TABLE `gym_reservation`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_roles`
--
ALTER TABLE `gym_roles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `gym_source`
--
ALTER TABLE `gym_source`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_store`
--
ALTER TABLE `gym_store`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gym_user_workout`
--
ALTER TABLE `gym_user_workout`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `gym_workout_data`
--
ALTER TABLE `gym_workout_data`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `installment_plan`
--
ALTER TABLE `installment_plan`
...
--
-- AUTO_INCREMENT de la tabla `membership_activity`
--
ALTER TABLE `membership_activity`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `membership_history`
--
ALTER TABLE `membership_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT de la tabla `membership_payment_history`
--
ALTER TABLE `membership_payment_history`
  MODIFY `payment_history_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
